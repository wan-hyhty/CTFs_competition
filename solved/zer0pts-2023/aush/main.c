...
int main(int argc, char **argv, char **envp) {
  char *args[3];
  char inpuser[LEN_USER+1] = { 0 }; //0x11
  char inppass[LEN_PASS+1] = { 0 }; //0x21
  char username[LEN_USER] = { 0 };  //0x10
  char password[LEN_PASS] = { 0 };  //0x20
