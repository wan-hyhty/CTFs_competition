...
void info(){
	...
	puts("I reccomend gdb pwndbg, which you can read about at https://github.com/pwndbg/pwndbg.\n");
...
void rop(){
	...
	puts(">>> p = process('./introduction') #use this one to test locally");	
